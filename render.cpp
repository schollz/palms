...
bool setup(BelaContext *context, void *userData)
{
	...
	for(unsigned int i = 0; i < 20; i++) {
		cl[i]=Comb(randfloat(0.01,0.1),randfloat(1,4),randfloat(0,0.5),context->audioSampleRate);
		cr[i]=Comb(randfloat(0.01,0.1),randfloat(1,4),randfloat(0,0.5),context->audioSampleRate);
	}
